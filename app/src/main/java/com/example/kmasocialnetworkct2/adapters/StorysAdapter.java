...
import com.example.kmasocialnetworkct2.databinding.ItemStatusBinding;
...
public class StorysAdapter extends RecyclerView.Adapter<StorysAdapter.TopStatusViewHolder> {
    ...
    public StorysAdapter(Context context, ArrayList<UserStatus> userStatuses) {
